  ...
  return (
    <div>
      ...
      <p>
        ...
        prompt resolution of problem situations conducting analytical work to
        reduce costs
      </p>
      <p>
      ...
      <p>LLC "Retail-Ukraine" Controller of food products 2020-2020</p>
      <p>
        quality control of product selection detection and elimination of
        selection errors documentation management
      </p>
      <p>
